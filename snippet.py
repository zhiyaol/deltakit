...
def draw_patch(self, dataQubitClickCallback = lambda _: None, ancillaQubitClickCallback = lambda _: None, filename: Optional[str] = None, unrotated_code: bool = False) -> go.FigureWidget:
    ...
    pauli_marker_colors = ['red', 'green', 'blue']
...
def update_patch(self, f: go.FigureWidget, dataQubitClickCallback = lambda _: None, ancillaQubitClickCallback = lambda _: None, filename: Optional[str] = None, unrotated_code: bool = False) -> go.FigureWidget:
    """
